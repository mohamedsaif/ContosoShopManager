...
namespace Contoso.CognitivePipeline.API.Controllers
{
    ...
    public class IDAuthController : ControllerBase
    {
        ...
        public IDAuthController(IStorageRepository storage, IDocumentDBRepository<SmartDoc> documentDBRepository, IDocumentDBRepository<User> uReposiroty, INewCognitiveRequest<SmartDoc> newAsyncReq)
        {
