...
namespace Contoso.CognitivePipeline.API.Controllers
{
    ...
    {
        public const ClassificationType docType = ClassificationType.Face;
        ...
        public FaceAuthController(IStorageRepository storage, IDocumentDBRepository<SmartDoc> documentDBRepository, IDocumentDBRepository<User> uReposiroty, INewCognitiveRequest<SmartDoc> newAsyncReq)
        {
